...
public final class ExtensionLoader<T> {
    ...
    /**
     * 从资源文件中加载 单个的 KEY-全类名的信息
     * @param extensionClasses  KEY-全类名的信息 映射
     * @param classLoader 类加载器
     * @param resourceUrl SPI文件位置
     */
